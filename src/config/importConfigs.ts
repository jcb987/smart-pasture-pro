...
export const milkImportConfig: ImportConfig = {
  ...
  requiredColumns: [
    { db: 'animal_tag', labels: ['arete', 'id', 'tag_id', 'animal', 'vaca', 'identificacion'] },
    { db: 'production_date', labels: ['fecha', 'date', 'dia'] },
  ],
  optionalColumns: [
    { db: 'morning_liters', labels: ['manana', 'am', 'morning', 'litros_am', 'litros am', 'ordeño_am', 'ordeño am'] },
    { db: 'afternoon_liters', labels: ['tarde', 'pm', 'afternoon', 'litros_pm', 'litros pm', 'ordeño_pm', 'ordeño pm'] },
    { db: 'evening_liters', labels: ['noche', 'evening', 'litros_noche'] },
    { db: 'total_liters', labels: ['total', 'litros', 'produccion', 'total_litros', 'total litros'] },
    { db: 'fat_percentage', labels: ['grasa', 'fat', 'porcentaje_grasa', '%grasa', 'grasa %', 'grasa%'] },
    { db: 'protein_percentage', labels: ['proteina', 'protein', 'porcentaje_proteina', '%proteina', 'proteina %', 'proteina%'] },
    { db: 'somatic_cell_count', labels: ['ccs', 'celulas', 'scc', 'celulas_somaticas'] },
    { db: 'notes', labels: ['notas', 'observaciones', 'notes', 'estado vaca', 'estado_vaca'] },
  ],
  templateData: [
